...
const ListInvoice = () => {
    const listinvoice = [
        { invoicename: 'Sales invoice', amount: '1,500,000', bonus: '500,000', date: '12-10-2024', status:'pending'},
      ];
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-xl">
              ...
              <tbody>
                {listinvoice.map((invoiceList) => (
                  <tr key={invoiceList.fullname} className="border-b text-md border-gray-200 hover:bg-gray-50">
